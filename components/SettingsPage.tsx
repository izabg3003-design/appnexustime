      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-8">
          ...
          <div className="bg-slate-800/20 border border-slate-800 p-8 rounded-[2.5rem] space-y-6 shadow-xl relative overflow-hidden">
            {!isPro && (
              <div className="absolute inset-0 z-10 bg-slate-950/60 backdrop-blur-[2px] flex flex-col items-center justify-center p-6 text-center">
                <div className="w-12 h-12 bg-purple-600/20 rounded-2xl flex items-center justify-center mb-3 border border-purple-500/30">
                  <Crown className="w-6 h-6 text-purple-400" />
                </div>
                <p className="text-[10px] font-black text-white uppercase tracking-widest mb-1">Recurso Premium</p>
                <p className="text-[9px] font-bold text-slate-400 uppercase tracking-tight max-w-[200px]">Ative a sua licença Pro para personalizar taxas de horas extras.</p>
              </div>
            )}
            ...
            <div className={`grid md:grid-cols-3 gap-6 ${!isPro ? 'opacity-40 grayscale pointer-events-none' : ''}`}>
              <div className="space-y-2">
