...
const LandingPage: React.FC<Props> = ({ onLogin, onSubscribe, onStartFree, onPrivacy, onTerms, onAbout, t, lang, setLang }) => {
        ...
        <section className="pt-48 md:pt-64 pb-20 px-6 text-center">
          <div className="max-w-4xl mx-auto space-y-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
               <button onClick={onStartFree} className="w-full sm:w-auto px-12 py-7 bg-emerald-500 text-slate-950 rounded-2xl font-black uppercase text-xs tracking-widest hover:bg-emerald-400 transition-all shadow-[0_20px_40px_rgba(16,185,129,0.2)] active:scale-95">Começar de forma gratuita!</button>
